...
class Api_Guard extends PhalApi_Api {
	...
	public function getList() {
        ...
        $privilege=array(
            array('title'=>'身份标识','des'=>'聊天区显示守护身份标识','thumb_c'=>get_upload_path('/static/guard/guard_1.png'),'thumb_g'=>get_upload_path('/static/guard/guard_0.png')),
            array('title'=>'进场特效','des'=>'拥有进场金光以及专属欢迎语','thumb_c'=>get_upload_path('/static/guard/enter_c.png'),'thumb_g'=>get_upload_path('/static/guard/enter_g.png')),
            array('title'=>'专属礼物','des'=>'拥有直播间守护用户才可以送出的专属礼物','thumb_c'=>get_upload_path('/static/guard/gift_c.png'),'thumb_g'=>get_upload_path('/static/guard/gift_g.png')),
            array('title'=>'尊贵特权','des'=>'防止除主播外的其他人踢出禁言','thumb_c'=>get_upload_path('/static/guard/privilege_c.png'),'thumb_g'=>get_upload_path('/static/guard/privilege_g.png')),
        );
	...
	public function buyGuard() {
        ...
        $guardid=checkNull($this->guardid);
