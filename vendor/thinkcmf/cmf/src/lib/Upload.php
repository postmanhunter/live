...
//        }
        ...
        if ($storageType != 'Local') { //  增加存储驱动
            $watermark = cmf_get_plugin_config($storageType);
            $storage   = new Storage($storageType, $storage['storages'][$storageType]);
