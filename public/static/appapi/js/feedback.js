			...
			({
				...
				success: function(data){
					...
					if(str.ret==200){
						...
						//console.log(str.data.file_name);
						$("#thumb").val(str.data.file_name);
				...
				error: function(data) 
				{
                    ...
                    $(".shadd[data-select="+img+"]").hide();
                    $("img[data-index="+img+"]").attr("src","/static/appapi/images/family/no2.jpg");
				}
			  })
			return true;
		});
    ...
    function save() {
        ...
        $.ajax( {
            type: "post",
            url: "/Appapi/Feedback/feedbackSave",
            dataType: "json",
            cache:false,
            timeout : 30000,
            data: {
