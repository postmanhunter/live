...
$(function(){ 
			...
			success:function(data){
				...
				if(data.code==0){
					...
					for(var i=0;i<length;i++){
						...
						// }else{
							html+='<span class="ok" data-familyid="'+list[i]['id']+'">加入</span>';
						// }
			...
			success:function(data){
				...
				if(data.code==0){
					layer.msg(data.msg,{},function(){
						location.href="familyindex://host/Appapi/Family/index"; //host参数APP端会替换为当前站点域名
					});
				}else{
					layer.msg(data.msg);
					return !1;
	...
	//审核状态等为失败时 进入家族中心
	$(".enter_family_index").click(function(){
		//alert("dddddd");
		location.href="familyindex://host/Appapi/Family/index"; //host参数APP端会替换为当前站点域名
	});
