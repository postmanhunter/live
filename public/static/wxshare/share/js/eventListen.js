...
var JsInterface={
	...
	chatFromSocket: function(data) {
		...
		}else if(msgmethod=='SystemNot' || msgmethod=='ShutUpUser'){ //系统信息
	...
	{
		layer.msg('该直播间涉嫌违规，已被停播',{},function(){
	...
	{
		this.systemNot(data);
		if(data.touid==User.id)
		{
			layer.msg('你已经被踢出房间',{},function(){
                location.href='/wxshare/Share/index';
            });
		}
